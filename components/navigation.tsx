...
export function Navigation() {
  ...
  return (
    ...
    <nav className="fixed top-0 w-full bg-[#fafaf2] backdrop-blur-sm z-50 border-b border-border">

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 lg:py-2 py-2">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <Link href="/" className="flex items-center gap-2">
            ...
            <img src="/logo.png" alt="IRA Beauty Academy" className="lg:h-[70px] h-[60px] w-auto" />
